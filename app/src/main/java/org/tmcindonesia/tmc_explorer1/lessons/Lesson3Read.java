package org.tmcindonesia.tmc_explorer1.lessons;
...
import org.tmcindonesia.tmc_explorer1.questions.LESSON3;

public class Lesson3Read extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_goToQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), LESSON3.class));
            }
        });
    }
}