...
public class LESSON6 extends AppCompatActivity {
    ...
    private int correctAnswerQuestionsPage[] = {1, 1, 0, 1, 0};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_explorer1_question6);
        ...
        String trueAnswerTreasureHunt = "JESUS IS OUR LIVING SAVIOR WITH ALL POWER";
        ...
        checkAnswerTreasureHunt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userInputAnswer.equals(trueAnswerTreasureHunt.trim())) {
                    ...
                    checkAnswerTreasureHunt.setBackgroundColor(ContextCompat.getColor(LESSON6.this, R.color.green_true_answer));
                    // notify correct answer
                    Toast.makeText(LESSON6.this, "Jawaban Kamu Benar!", Toast.LENGTH_SHORT).show();
                }
                if (!userInputAnswer.equals(trueAnswerTreasureHunt.trim())) {
                    // change button color to red
                    checkAnswerTreasureHunt.setBackgroundColor(ContextCompat.getColor(LESSON6.this, R.color.red_false_answer));
                    // notify wrong answer
                    Toast.makeText(LESSON6.this, "Jawaban Kamu Salah, ayo coba lagi", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        rgqp_question1 = (RadioGroup) findViewById(R.id.radioGroup_QuestionPage6_MultipleChoiceQuestion1);
        rgqp_question2 = (RadioGroup) findViewById(R.id.radioGroup_QuestionPage6_MultipleChoiceQuestion2);
        rgqp_question3 = (RadioGroup) findViewById(R.id.radioGroup_QuestionPage6_MultipleChoiceQuestion3);
        rgqp_question4 = (RadioGroup) findViewById(R.id.radioGroup_QuestionPage6_MultipleChoiceQuestion4);
        rgqp_question5 = (RadioGroup) findViewById(R.id.radioGroup_QuestionPage6_MultipleChoiceQuestion5);
        // get layout ID text view question
        textView_quesion1 = (TextView) findViewById(R.id.textView_QuestionPage6_MultipleChoiceQuestion1);
        textView_quesion2 = (TextView) findViewById(R.id.textView_QuestionPage6_MultipleChoiceQuestion2);
        textView_quesion3 = (TextView) findViewById(R.id.textView_QuestionPage6_MultipleChoiceQuestion3);
        textView_quesion4 = (TextView) findViewById(R.id.textView_QuestionPage6_MultipleChoiceQuestion4);
        textView_quesion5 = (TextView) findViewById(R.id.textView_QuestionPage6_MultipleChoiceQuestion5);
        ...
        // get layout ID
        mjwj_answer1 = (EditText) findViewById(R.id.editText_QuestionPage6_MJWJAnswer1);
        mjwj_answer2 = (EditText) findViewById(R.id.editText_QuestionPage6_MJWJAnswer2);
        mjwj_answer3 = (EditText) findViewById(R.id.editText_QuestionPage6_MJWJAnswer3);
        mjwj_answer4 = (EditText) findViewById(R.id.editText_QuestionPage6_MJWJAnswer4);
